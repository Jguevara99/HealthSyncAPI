...
public class SwaggerAuthorizationOperationFilter : IOperationFilter
{
    public void Apply(OpenApiOperation operation, OperationFilterContext context)
    {
        ...
        {
            $"{nameof(AuthorizeAttribute.Policy)}:{authAttribute.Policy}",
            $"{nameof(AuthorizeAttribute.Roles)}:{authAttribute.Roles}",
            $"{nameof(AuthorizeAttribute.AuthenticationSchemes)}:{authAttribute.AuthenticationSchemes}"
        };
